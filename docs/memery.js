...
<body>
  <div id="sidebar">
    <button class="function-btn" onclick="document.getElementById('functionPanel').classList.toggle('hidden')">⚙️</button>
  ...
  <div id="main">
    <img id="avatarImage" src="cartoon_persona.png" alt="Avatar">
    <div id="chatBox"></div>
    <button id="expandChatBtn" style="font-size: 10px; padding: 2px 6px; margin-top: 4px;">🔍</button>
    <div id="controls">
    ...
    async function fetchResponse(input) {
      const res = await fetch("https://api.openai.com/v1/chat/completions", {
        ...
        headers: {
          ...
          Authorization: `Bearer ${localStorage.getItem('invoke_api_key')}`
        },
        body: JSON.stringify({
          model: "gpt-3.5-turbo",
      ...
      return (data.choices && data.choices[0] && data.choices[0].message && data.choices[0].message.content) ? data.choices[0].message.content : "No response.";
    }
